...
class FinesPaymentFragment : Fragment() {

    private var param1: String? = null
    private var param2: String? = null
    private var _binding: FragmentFinesPaymentBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentFinesPaymentBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    private fun deductBalanceAndSaveTransaction(
        ...
        val transactionNumber = generateTransactionNumber("SUF")
