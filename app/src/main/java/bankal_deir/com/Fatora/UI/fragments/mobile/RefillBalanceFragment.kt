...
import bankal_deir.com.databinding.FragmentRefillBalanceBinding
import com.google.firebase.auth.FirebaseAuth
import com.google.firebase.database.*
import java.text.SimpleDateFormat
import java.util.*

class RefillBalanceFragment : Fragment() {

    private var _binding: FragmentRefillBalanceBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentRefillBalanceBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    private fun processPayment() {
        ...
        if (amountText.isEmpty()) {
            Toast.makeText(requireContext(), "Refill amount is required", Toast.LENGTH_SHORT).show()
            return
        }
        ...
        getUserWalletId(userId, amount, mobileNumber)
    }
    ...
    private fun deductBalanceAndSaveTransaction(
        ...
        val transactionNumber = generateTransactionNumber("SMR")
