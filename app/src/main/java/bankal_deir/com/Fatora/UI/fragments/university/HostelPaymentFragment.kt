...
import bankal_deir.com.databinding.FragmentHostelPaymentBinding
...
class HostelPaymentFragment : Fragment() {
    private var param1: String? = null
    private var param2: String? = null
    private var _binding: FragmentHostelPaymentBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentHostelPaymentBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    private fun processPayment() {
        ...
        if (amountText.isEmpty()) {
            Toast.makeText(requireContext(), "Hostel fee amount is required", Toast.LENGTH_SHORT).show()
            return
        }
    ...
    private fun deductBalanceAndSaveTransaction(
        ...
        val transactionNumber = generateTransactionNumber("SUH")
