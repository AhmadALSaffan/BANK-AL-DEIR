...
class ImmigrationFineFragment : Fragment() {
    private var param1: String? = null
    private var param2: String? = null

    private var _binding: FragmentImmigrationFineBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentImmigrationFineBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    private fun processPayment() {
        ...
        if (amountText.isEmpty()) {
            Toast.makeText(requireContext(), "Fine amount is required", Toast.LENGTH_SHORT).show()
            return
        }
        ...
        OtpGate.require(requireActivity(), onCancelled = { binding.continueButton.isEnabled = true; binding.continueButton.text = "Continue to payment" }) { getUserWalletId(userId, amount, idNumber) }
    }

    private fun getUserWalletId(userId: String, amount: Double, idNumber: String) {
        ...
        usersRef.addListenerForSingleValueEvent(object : ValueEventListener {
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                checkBalanceAndPay(userId, walletId, amount, idNumber)
            }
    ...
    private fun checkBalanceAndPay(userId: String, walletId: String, amount: Double, idNumber: String) {
        ...
        walletRef.addListenerForSingleValueEvent(object : ValueEventListener {
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                deductBalanceAndSaveTransaction(userId, walletId, newBalance, amount, idNumber)
            }
    ...
    private fun deductBalanceAndSaveTransaction(
        ...
        val transactionNumber = generateTransactionNumber("SGF")
