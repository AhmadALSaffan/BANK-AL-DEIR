...
public final class ProgressBinding implements ViewBinding {
  ...
  private ProgressBinding(@NonNull ConstraintLayout rootView, @NonNull ProgressBar progressBar) {
  ...
  public static ProgressBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ProgressBinding((ConstraintLayout) rootView, progressBar);
    }
